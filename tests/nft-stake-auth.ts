...
//   'AyRhD1Yh8MAdZAhQL8eK1FZcogg1GW4Y87HqsWJytTzo'
...
//   'HMAA7vvmESq6qzE6iuhAfPrr6AefHHBJs7KvfsoMSkye'
// ); // Token account for the reward token

//constants
const collectionAddress = new PublicKey(
  'CLQ1KJSUQun9uR8PHzPENKHc7yPk8FHWMcLiA8bgZPaB'
); // Mint Address of the Collection NFT for which the staking to be activated
const tokenMint = new PublicKey('eqxSsyJr3JY9p5fxjmtcRdi47RdyirF5ngay964BZMM'); // Mint of the Token to be given as reward
const tokenAccount = new PublicKey(
  '8v1YUUrWKA7xNdcyeHcKm4W8qc8d4L6nvyk6rg9tvCUW'
); // Token account for the reward token
...
// NFT of the collection - must be owned by the Signer
const nftMint = new PublicKey('491FNxG5ZSg7TfFofKGMXfTJULhChNSwcGR9n7MW5Ujq');
const nftToken = new PublicKey('FFhn7rZF4tKe5gFENtWqdFp8Km565zsqYzLNayvzbohK');
const nftMetadata = new PublicKey(
  '9naYoZ4uZxCPPvQPnQwzmFFnFKwrLiUNLf7sQnqWr4RN'
);
const nftEdition = new PublicKey(
  '4xWpMxexWa1PCMeuf4r29VYTzJYsvsbiUFWUJxzStTPn'
);
...
const nftMetadata2 = new PublicKey(
  'C5TEagbhLjyhhVeWcCGJBFHwZt6TSWZaoXxK3q2Tpwg1'
);
const nftEdition2 = new PublicKey(
  'D9XovNCb3Jgt5t4akUDdWnRPovRaZr2uxwJdzhNhDxU8'
);
